...
only holds the $\frac{N}{2} + 1$ relevant coefficients, and not the symmetrical ones.

\subsubsection{Modulated complex lapped transform}
This transform was referred to in \cite{malvar1999modulated}. It seems that it can provide better results with the spread-spectrum technique.
...
The testing of core features (e.g. transforms, overlap, windowing, etc...) is achieved by null-testing to the reference audio.
\section{GUI}
\subsection{Capabilities}
